...
def GetData(url):
	...
	'Referer': 'https://www.***.com/jobs/list_%E7%88%AC%E8%99%AB?labelWords=&fromSearch=true&suginput='
	}
	payload=(
	{'first': 'true',
	'pn': '1',
...
if __name__=='__main__':
	url1='https://www.***.com/jobs/positionAjax.json?needAddtionalResult=false'
	data1=GetData(url1)
	LoadData(data1)
	print('the end')
